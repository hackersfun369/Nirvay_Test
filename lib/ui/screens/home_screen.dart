...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomSheet: musicProvider.tracks.isNotEmpty || musicProvider.trendingTracks.isNotEmpty 
          ? const MiniPlayer() 
          : null,
          ...
          child: CustomScrollView(
            slivers: [
              SliverPadding(
                ...
                sliver: SliverList(
                  delegate: SliverChildListDelegate([
                    ...
                    // Welcome Grid
                    if (musicProvider.trendingTracks.isNotEmpty)
                      GridView.builder(
                        shrinkWrap: true,
                        ...
                        itemCount: musicProvider.trendingTracks.length.clamp(0, 6),
                    ...
                    _SectionHeader(title: 'Trending Tracks'),
                    const SizedBox(height: 16),
                  ]),
                ),
              ),
              ...
              if (musicProvider.recentlyPlayed.isNotEmpty) ...[
                SliverToBoxAdapter(child: _SectionHeader(title: 'Recently Played', padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 16))),
                 SliverToBoxAdapter(
                  child: SizedBox(
                    height: 220,
              ...
              if (musicProvider.quickPicks.isNotEmpty) ...[
                 SliverToBoxAdapter(child: _SectionHeader(title: 'Quick Picks for You', padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 16))),
                 SliverToBoxAdapter(
                  child: SizedBox(
                    height: 220,
                    child: ListView.builder(
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return SpotifyCard(
                          ...
                          onTap: () => playerProvider.play(context, album),
                        );
                      },
                    ),
                  ),
